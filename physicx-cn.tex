...
\pkg{physics} 宏包定义了一些简写的命令，但是已经9年未更新了，\pkg{physicx} 对其进行了一定的展开，基本兼容 \pkg{physics} 原有的命令。
...
\pkg{physicx} 宏包极大地展开了 \pkg{physics} 原有的矩阵类命令。提供了丰富的
键值接口来设置矩阵。
