...
set MODE=-interaction=errorstopmode -synctex=1 -file-line-error
...
set NOPDFMODE=-interaction=errorstopmode -synctex=1 -file-line-error --no-pdf
set MODE=-interaction=errorstopmode -synctex=1 -file-line-error -pdf
